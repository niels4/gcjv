...
(defn processCase [{:keys [caseNumber credit items]}] (let [validItems (filter (fn* [p1__826966#] (< (:value p1__826966#) credit)) items) halfCredit (/ credit 2) bigItems (filter (fn* [p1__826967#] (> (:value p1__826967#) halfCredit)) validItems) smallItems (filter (fn* [p1__826968#] (< (:value p1__826968#) halfCredit)) validItems) halfItems (filter (fn* [p1__826969#] (= (:value p1__826969#) halfCredit)) validItems) resultItems (if (second halfItems) halfItems (->> (for [big bigItems small smallItems :when (= credit (+ (:value big) (:value small)))] [big small]) first)) result (->> resultItems (map :index) sort (join " "))] {:caseNumber caseNumber, :result result}))
