...
(defn processCase [{:keys [caseNumber credit items]}] (let [validItems (filter (fn* [p1__731441#] (< (:value p1__731441#) credit)) items) halfCredit (/ credit 2) bigItems (filter (fn* [p1__731442#] (> (:value p1__731442#) halfCredit)) validItems) smallItems (filter (fn* [p1__731443#] (< (:value p1__731443#) halfCredit)) validItems) halfItems (filter (fn* [p1__731444#] (= (:value p1__731444#) halfCredit)) validItems) resultItems (if (= 2 (count halfItems)) halfItems (->> (for [big bigItems small smallItems :when (= credit (+ (:value big) (:value small)))] [big small]) first)) result (->> resultItems (map :index) sort (join " "))] {:caseNumber caseNumber, :result result}))
