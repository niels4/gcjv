...
^{:line 24} (defn processCase [{:keys [caseNumber credit items]}] ^{:line 26} (let [validItems ^{:line 27} (filter (fn* [p1__759039#] ^{:line 27} (< ^{:line 27} (:value p1__759039#) credit)) items) halfCredit ^{:line 28} (/ credit 2) bigItems ^{:line 29} (filter (fn* [p1__759040#] ^{:line 29} (> ^{:line 29} (:value p1__759040#) halfCredit)) validItems) smallItems ^{:line 30} (filter (fn* [p1__759041#] ^{:line 30} (< ^{:line 30} (:value p1__759041#) halfCredit)) validItems) halfItems ^{:line 31} (filter (fn* [p1__759042#] ^{:line 31} (= ^{:line 31} (:value p1__759042#) halfCredit)) validItems) resultItems ^{:line 32} (if ^{:line 32} (= 2 ^{:line 32} (count halfItems)) halfItems ^{:line 34} (->> ^{:line 34} (for [big bigItems small smallItems :when ^{:line 36} (= credit ^{:line 36} (+ ^{:line 36} (:value big) ^{:line 36} (:value small)))] [big small]) first)) result ^{:line 39} (->> resultItems ^{:line 40} (map :index) sort ^{:line 42} (join " "))] {:caseNumber caseNumber, :result result}))
