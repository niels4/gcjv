...
^{:line 24} (defn processCase [{:keys [caseNumber credit items]}] ^{:line 26} (let [validItems ^{:line 27} (filter (fn* [p1__166044#] ^{:line 27} (< ^{:line 27} (:value p1__166044#) credit)) items) halfCredit ^{:line 28} (/ credit 2) bigItems ^{:line 29} (filter (fn* [p1__166045#] ^{:line 29} (> ^{:line 29} (:value p1__166045#) halfCredit)) validItems) smallItems ^{:line 30} (filter (fn* [p1__166046#] ^{:line 30} (< ^{:line 30} (:value p1__166046#) halfCredit)) validItems) halfItems ^{:line 31} (filter (fn* [p1__166047#] ^{:line 31} (= ^{:line 31} (:value p1__166047#) halfCredit)) validItems) resultItems ^{:line 32} (if ^{:line 32} (second halfItems) halfItems ^{:line 34} (->> ^{:line 34} (for [big bigItems small smallItems :when ^{:line 36} (= credit ^{:line 36} (+ ^{:line 36} (:value big) ^{:line 36} (:value small)))] [big small]) first)) result ^{:line 39} (->> resultItems ^{:line 40} (map :index) sort ^{:line 42} (join " "))] {:caseNumber caseNumber, :result result}))
